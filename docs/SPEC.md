...
|Вошел ли пользователь|Да, если в **своём** хранилище WebView есть `__Secure-1PSID` и страница пришла с хоста `gemini.google.com`; окончательно подтверждает RPC `otAQ7b` со статусом 1000|
